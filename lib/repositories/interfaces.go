...
type DeckRepository interface {
	...
	GetAllByPodPaginated(ctx context.Context, podID, limit, offset int) ([]deck.Model, int, error)
	GetAllByPlayerPaginated(ctx context.Context, playerID, limit, offset int) ([]deck.Model, int, error)
...
type GameRepository interface {
	...
	GetAllByPodPaginated(ctx context.Context, podID, limit, offset int) ([]game.Model, int, error)
	GetAllByDeckPaginated(ctx context.Context, deckID, limit, offset int) ([]game.Model, int, error)
	GetAllByPlayerIDPaginated(ctx context.Context, playerID, limit, offset int) ([]game.Model, int, error)

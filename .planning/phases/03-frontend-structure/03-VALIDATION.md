...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 3-01-01 | 01 | 1 | FEND-02, FEND-03 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-01-02 | 01 | 1 | FEND-02, FEND-03 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-02-01 | 02 | 1 | FEND-04, FEND-05 | compile + grep | `cd app && ./node_modules/.bin/tsc --noEmit && grep -q 'justifyContent' src/routes/RequireAuth.tsx` | N/A | pending |
| 3-02-02 | 02 | 1 | DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-03-01 | 03 | 2 | FEND-01, FEND-02, DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-03-02 | 03 | 2 | DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-04-01 | 04 | 2 | FEND-01, FEND-02 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-04-02 | 04 | 2 | DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-05-01 | 05 | 2 | FEND-01, FEND-02, DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-06-01 | 06 | 2 | FEND-01, DSNG-04 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
| 3-06-02 | 06 | 2 | FEND-01 | compile | `cd app && ./node_modules/.bin/tsc --noEmit` | N/A | pending |
...
|----------|-------------|------------|-------------------|
| No blank screen on page refresh | FEND-04 | Browser navigation state not testable with jest | Load app, navigate to `/pod/:podId`, refresh browser, confirm centered spinner then page renders |

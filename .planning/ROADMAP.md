...
- [ ] 05-02-PLAN.md — Frontend quick fixes: Record min 4 places, icon link, DecksTab sort, retired filter, cancel button (POD-03, DECK-02, DECK-03)

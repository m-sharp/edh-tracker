...
- [ ] **FEND-02**: Shared tab component used across Pod, Player, and Deck views — active tab persisted via query string, shared loading/error state
- [ ] **FEND-03**: Shared tooltip icon and tooltip icon button components available and used where applicable
